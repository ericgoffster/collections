 ...
 */
public final class List23<E> implements ImmCollection23<E> {
    /**
     ...
     */
    public static <E> List23<E> ofSortedUnique(final Comparator<? super E> comparator,final Iterable<? extends E> elements) {

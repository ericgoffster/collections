...
public class SortedMap23MapTest {
    ...
    public void testFirstKey() {
        SortedMap<Integer, Integer> l = TreeMap23.of(Arrays.asList(makeEntry(0,1), makeEntry(3,2), makeEntry(6,3), makeEntry(9,4), makeEntry(12,5))).asMap();
        assertEquals(l.firstKey().intValue(), 0);
        assertEquals(l.lastKey().intValue(),12);
        
        assertThrows(NoSuchElementException.class, () -> TreeMap23.empty().asMap().firstKey());
        assertThrows(NoSuchElementException.class, () -> TreeMap23.empty().asMap().lastKey());
    }
